...
export function SunDirection({ goldenHourData, deviceOrientation }) {
  ...
  useEffect(() => {
    ...
    const adjustedSunAngle = deviceOrientation !== null ? sunAngle - rotation * (Math.PI / 180) : sunAngle
      ...
      <CardContent>
        <div className="flex flex-col items-center">
          ...
          <div className="text-sm text-center mt-2">
            ...
            <p className="font-medium mt-1">Sun azimuth: {Math.round(goldenHourData.currentSunAzimuth)}°</p>
          </div>
        </div>
      </CardContent>
    </Card>
